...
# LOCAL=true docker buildx bake --builder virtualized-environments tools-helix
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder virtualized-environments tools-helix
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder virtualized-environments tools-helix
target "tools-helix" {
    context="./tools/helix"
    dockerfile = "Dockerfile"
    tags = [
