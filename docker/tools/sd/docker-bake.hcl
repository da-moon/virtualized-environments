...
# docker buildx create --use --name "tools-sd" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-sd tools-sd
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-sd tools-sd
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-sd tools-sd
target "tools-sd" {
    context="."
