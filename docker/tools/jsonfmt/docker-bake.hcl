...
# docker buildx create --use --name "tools-jsonfmt" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-jsonfmt tools-jsonfmt
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-jsonfmt tools-jsonfmt
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-jsonfmt tools-jsonfmt
