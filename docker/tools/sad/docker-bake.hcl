...
# docker buildx create --use --name "tools-sad" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-sad tools-sad
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-sad tools-sad
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-sad tools-sad
target "tools-sad" {
    context="."
