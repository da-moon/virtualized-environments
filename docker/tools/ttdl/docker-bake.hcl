...
# docker buildx create --use --name "tools-ttdl" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-ttdl tools-ttdl
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-ttdl tools-ttdl
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-ttdl tools-ttdl
target "tools-ttdl" {
    context="."
