...
# docker buildx create --use --name "tools-delta" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-delta tools-delta
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-delta tools-delta
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-delta tools-delta
target "tools-delta" {
    context="."
