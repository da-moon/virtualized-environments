...
# docker buildx create --use --name "tools-cellar" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-cellar tools-cellar
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-cellar tools-cellar
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-cellar tools-cellar
target "tools-cellar" {
    context="."
