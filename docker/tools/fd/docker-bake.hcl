...
# docker buildx create --use --name "tools-fd" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-fd tools-fd
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-fd tools-fd
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-fd tools-fd
target "tools-fd" {
    context="."
