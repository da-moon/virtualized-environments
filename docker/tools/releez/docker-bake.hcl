...
# docker buildx create --use --name "tools-releez" --driver docker-container

# LOCAL=true docker buildx bake --builder tools-releez tools-releez
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder tools-releez tools-releez
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder tools-releez tools-releez
target "tools-releez" {
    context="."
