...
# docker buildx create --use --name "devcontainer-rust-alpine" --driver docker-container

# LOCAL=true docker buildx bake --builder devcontainer-rust-alpine devcontainer-rust-alpine
# LOCAL=true ARM64=false AMD64=true docker buildx bake --builder devcontainer-rust-alpine devcontainer-rust-alpine
# LOCAL=true ARM64=true AMD64=false docker buildx bake --builder devcontainer-rust-alpine devcontainer-rust-alpine
